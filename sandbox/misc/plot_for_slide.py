...
fig, ax = plt.subplots(figsize=(16 * scale, 10 * scale))
plt.plot(np.linspace(0, 5000, 5000)[::10], ssims[13][::10], label="Standard FWI method", linestyle="--", color="#460e44", linewidth=2)
plt.plot(np.linspace(0, 5000, 5000)[::10], ssims[-1][::10], label="Standard FWI method(noisy)", linestyle="--", color="#00a381", linewidth=3)
plt.plot(np.linspace(0, 5000, 5000)[::10], ssims[7][::10], label="Proposed method", color="#460e44", linewidth=2)
plt.plot(np.linspace(0, 5000, 5000)[::10], ssims[21][::10], label="Proposed method(noisy)", color="#00a381", linewidth=3)
