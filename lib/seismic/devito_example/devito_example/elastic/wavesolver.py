...
class ElasticWaveSolver(object):
    ...
    def forward(self, src=None, rec1=None, rec2=None, v=None, tau=None, model=None, save=None, **kwargs):
        """
        ...
        v = v or VectorTimeFunction(name="v", grid=self.model.grid, save=save_t, space_order=self.space_order, time_order=1)
        tau = tau or TensorTimeFunction(name="tau", grid=self.model.grid, save=save_t, space_order=self.space_order, time_order=1)
