...
class ViscoelasticWaveSolver(object):
    ...
    def op_fwd(self, save=None):
        ...
        return ForwardOperator(self.model, save=save, geometry=self.geometry, space_order=self.space_order, **self._kwargs)

    def forward(self, src=None, rec1=None, rec2=None, v=None, tau=None, r=None, model=None, save=None, **kwargs):
        """
        ...
        v = v or VectorTimeFunction(name="v", grid=self.model.grid, save=save_t, time_order=1, space_order=self.space_order)
        # Stress:
        tau = tau or TensorTimeFunction(name="t", grid=self.model.grid, save=save_t, space_order=self.space_order, time_order=1)
        # Memory variable:
        r = r or TensorTimeFunction(name="r", grid=self.model.grid, save=save_t, space_order=self.space_order, time_order=1)
        ...
        summary = self.op_fwd(save).apply(src=src, rec1=rec1, rec2=rec2, dt=kwargs.pop("dt", self.dt), **kwargs)
