...
def viscoelastic_setup(shape=(50, 50), spacing=(15.0, 15.0), tn=500.0, space_order=4, nbl=10, constant=True, **kwargs):
...
def run(shape=(50, 50), spacing=(20.0, 20.0), tn=1000.0, space_order=4, nbl=40, autotune=False, constant=False, **kwargs):

    solver = viscoelastic_setup(shape=shape, spacing=spacing, nbl=nbl, tn=tn, space_order=space_order, constant=constant, **kwargs)
