\begin{figure}[t]
    ...
    \begin{tabular}{m{3mm} m{30mm} m{30mm} m{10mm}}
        ...
        \end{minipage} &
        \hspace{-3mm}
        \multirow[t]{3}{*}{\raisebox{-7mm}{\includegraphics[height=24mm]{public/seismic-data-color-bar}}} \\
    \end{tabular}
    \vspace{-2mm}
    \caption{ \centering The sinthesized seismic data \\ corresponding to a single source waveform}
    \vspace{-3mm}
