...
\newcommand{\projLOneTwoBallSolution}{ (\projLOneTwoBall{\vecx})_{\mathfrak{g}_i} = \bm p_{\mathfrak{g}_i} }
\newcommand{\projLOneTwoBallSolutionWhere}{
    \begin{aligned}
        & \bm p_{\mathfrak{g}_i} = \begin{cases}
            0                                              & \text{if} \ \LTwoNorm{\vecx_{\mathfrak{g}_i}} = 0, \\
            \bm \beta_i \frac {\vecx_{\mathfrak{g}_i}} {\LTwoNorm{\vecx_{\mathfrak{g}_i}}} & \text{otherwise},
        \end{cases} \\
        & \bm \beta = P_{ \{ \bm a \mid \LOneNorm{ \bm a } \le \alpha \} }({[ \LTwoNorm{ \vecx_{\mathfrak{g}_i} }, \ldots, \LTwoNorm{ \vecx_{\mathfrak{g}_N} } ]^T}). \\
    \end{aligned}
}
