...
\newcommand{\projBox}[1]{ P_{[a,b]^N} \left( #1 \right) }
...
\newcommand{\projLOneBallSolutionWhere}{
    \begin{aligned}
        ...
        & \beta'             = \text{max} \left\{ \frac 1 i \left((\sum_{j=1}^i \bm y_j) - \alpha\right) \middle| \ i = 1, \ldots, N \right\}, \\
...
\newcommand{\FWIObjectiveWithTVConstraint}{ E(\velModel) \ \ \ \text{s.t.} \ \  \begin{cases} \LOneTwoNorm{\diffOperator \velModel} \le \alpha, \\ \velModel \in [a,b]^N, \end{cases}}
