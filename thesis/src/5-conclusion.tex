In this paper, we developed an efficient algorithm to solve the TV and box constrained FWI problem% with neither inner loops nor approximations based on PDS. -> 後で書く
