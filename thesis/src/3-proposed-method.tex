...
This separation simplifies the formulation and allows $\alpha$ to directly control the smoothness, providing a clearer interpretation of the reconstructed subsurface properties.
