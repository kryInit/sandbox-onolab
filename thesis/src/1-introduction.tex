...
In addition, the methods rely on approximations, such as treating non-convex functions as convex and satisfying constraints outside the optimization method.
